...
/**
 * Implementazione di FormulaSolver per le proposizioni che seguono la logica di Kleene.
 */
public class FormulaSolverKleene extends FormulaSolver {
     ...
     */
    public FormulaSolverKleene(String I, String F, ArrayList<Character> PL) {
        super(I, F, PL);
        ...
        for(int i = 0; i < PL.size(); i++) {
            ...
            Proposizione p = new ProposizioneKleene(PL.get(i), 0);
        ...
        for(int e = 0; e < (int) Math.pow(3,PL.size()); e++) {
            ...
            //inserimento valore formula nella tavola di verità
