...
/**
 * Implementazione di FormulaSolver per le proposizioni che seguono la logica di Łukasiewicz.
 */
public class FormulaSolverLuka extends FormulaSolver {
     ...
     */
    public FormulaSolverLuka(String I, String F, ArrayList<Character> PL) {
        super(I, F, PL);
        ...
        for(int i = 0; i < PL.size(); i++) {
            ...
            Proposizione p = new ProposizioneLuka(PL.get(i), 0);
